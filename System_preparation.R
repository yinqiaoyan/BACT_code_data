...
### Install R package "BayesSpace"
BiocManager::install("BayesSpace")


### Install R package "BINRES" (our proposed model)
install.packages("PKG_PATH/BINRES_1.1.tar.gz", repos = NULL, type="source")
# PKG_PATH: the file path where "BINRES_1.1.tar.gz" locates.
