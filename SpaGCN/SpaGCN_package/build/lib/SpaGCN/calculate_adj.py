...
################
# change functions:
# 	detect_spatial_domains_ez_mode: input of the function calculate_adj_matrix
# 	alculate_adj_matrix: add input parameter platform=["ST", "Visium"]
# add functions:
...
def calculate_adj_matrix(x, y, x_pixel=None, y_pixel=None, image=None, beta=49, alpha=1, histology=True, platform="ST"):
...
def calculate_adj_matrix_input_g(x, y, g=None, alpha=1, histology=True):
	#x,y are lists
	if histology:
