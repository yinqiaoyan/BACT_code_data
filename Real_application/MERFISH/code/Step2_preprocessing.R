...
geneData_raw = read.csv("../input_data/gene_matrix_raw_19.csv")
...
# norm.type="logOnly": Since the raw data have been normalized, 
#    we only need to take log before conducting PCA.
...
save(coord, gene_data_pc, file = "../input_data/coord_and_pc_19.RData")
